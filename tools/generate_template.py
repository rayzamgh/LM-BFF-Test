...
def search_template(model, tokenizer, task_name, k, seed, beam, output_dir, data_dir):
    ...
    map_of_mapping = {
        ...
        'smsa': {0:'positif',1:'negatif',2:'neutral'},
        'emot': {0:'sedih',1:'takut',2:'marah',3:'cinta',4:'senang'},
        'wrete': {0:'salah',1:'benar'},
    ...
    if task_name in ['SST-2', 'sst-5','smsa','emot','wrete', 'mr', 'cr', 'subj', 'trec', 'CoLA', 'mpqa']:
...
def main():
    ...
    parser.add_argument('--task_name', type=str, nargs='+', default=['SST-2', 'sst-5', 'smsa','emot','wrete','mr', 'cr', 'subj', 'trec', 'CoLA', 'MRPC', 'QQP', 'STS-B', 'MNLI', 'SNLI', 'QNLI', 'RTE'], help="Task names")
