...
def get_sentence(task, line):
    if task in ['mr', 'sst-5', 'smsa','emot','wrete','subj', 'trec', 'cr', 'mpqa']:
...
def main():
    ...
    parser.add_argument("--task", type=str, nargs="+", default=["SST-2", "sst-5",'smsa','emot','wrete', "mr", "cr", "mpqa", "subj", "trec", "CoLA", "MRPC", "QQP", "STS-B", "MNLI", "SNLI", "QNLI", "RTE"], help="Tasks")
